...
################################################################################
'''output_file_name1 = './aligned_to_chainM/squig_bilds/SD_arrows_squiq_strand1_toM.bild'
output_file_name2 = './aligned_to_chainM/squig_bilds/SD_arrows_squiq_strand2_toM.bild'
output_file_names = './aligned_to_chainM/squig_bilds/SD_arrows_squig_eachStaple_toM'
...
output_file_name1 = './aligned_to_chainM/acat_bilds/SD_arrows_acat_strand1.bild'
output_file_name2 = './aligned_to_chainM/acat_bilds/SD_arrows_acat_strand2.bild'
output_file_names = './aligned_to_chainM/acat_bilds/SD_arrows_squig_eachStaple_toM'
bent_file_name = './aligned_to_chainM/acat_alignedStrProtomers.pdb'
output_diff_vects = './aligned_to_chainM/acat_diff_vects.npy'

output_file_name1 = './aligned_to_chainM/ctrlJ126_bilds/SD_arrows_ctrlJ126_strand1.bild'
output_file_name2 = './aligned_to_chainM/ctrlJ126_bilds/SD_arrows_ctrlJ126_strand2.bild'
output_file_names = './aligned_to_chainM/ctrlJ126_bilds/SD_arrows_squig_eachStaple_toM'
...
'''
output_file_name1 = './aligned_to_chainM/ctrlJ131_bilds/SD_arrows_ctrlJ131_strand1.bild'
output_file_name2 = './aligned_to_chainM/ctrlJ131_bilds/SD_arrows_ctrlJ131_strand2.bild'
output_file_names = './aligned_to_chainM/ctrlJ131_bilds/SD_arrows_squig_eachStaple_toM'
...
save_bild_each_staple(centroids, diff_vects_SDs, 40, 0, output_file_names)
...
save_bild_average_staple(np.expand_dims(np.mean(centroids[2:-2],axis=0),axis=0), np.expand_dims(avg_vectors,axis=0), 40, 0, './temp_output')
