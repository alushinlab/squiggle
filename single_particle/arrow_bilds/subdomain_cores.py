...
output_pdb_name = './in_helix_position/avgsquig_alignedStrProtomers.pdb'
...
output_pdb_name = './in_helix_position/acat_alignedStrProtomers.pdb'
...
output_pdb_name = './in_helix_position/ctrlJ126_alignedStrProtomers.pdb'
...
output_pdb_name = './in_helix_position/ctrlJ131_alignedStrProtomers.pdb'
...
def compute_alignedChains(ref, chains):
	...
	for i in range(0, len(chains)):
		trans_matrix = calcTransformation(ref, chains[i]) # align whole chain
		aligned_chain = applyTransformation(trans_matrix, ref)
...
################################################################################
diff_vects = bent - aligned_str_ref
scalar = 1.0
bent_scaled = bent + scalar*diff_vects
