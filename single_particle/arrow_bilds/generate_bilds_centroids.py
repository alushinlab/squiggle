...
################################################################################
output_file_name1 = './strand_swapping_align/aligned_to_straightStrands/centroid_arrows_DFHstrand1.bild'
output_file_name2 = './strand_swapping_align/aligned_to_straightStrands/centroid_arrows_DFHstrand2.bild'
str_file_name = './strand_swapping_align/aligned_to_straightStrands/str25subunits.pdb'
bent_file_name = './strand_swapping_align/aligned_to_straightStrands/avg_squig_alignedDFH_strand_delEdge.pdb'

# First load the pdb
bent = load_pdb(bent_file_name)
#straight = load_pdb(str_file_name)[2:-2] #CEG
straight = load_pdb(str_file_name)[1:-3] #DFH

diff_vects = bent - straight
...
centroids = np.asarray(centroids)#np.repeat(np.asarray(centroids), 21, axis=0)
...
save_bild_strand(centroids, diff_vects_SDs, 5, 0, output_file_name1)
save_bild_strand(centroids, diff_vects_SDs, 5, 1, output_file_name2)
